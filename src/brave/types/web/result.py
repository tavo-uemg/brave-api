...
class Result(BaseModel):
    ...
    is_source_local: Optional[bool] = Field(default=None, description="Indicates if the source of the web page is local.")
    is_source_both: Optional[bool] = Field(default=None, description="Indicates if the source of the web page is both local and non-local.")
