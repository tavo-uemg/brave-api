...
class Result(BaseModel):
    ...
    is_source_local: bool = Field(
        default=False, description="Indicates if the source of the web page is local."
    )
    is_source_both: bool = Field(
        default=False, description="Indicates if the source of the web page is both local and non-local."
    )
    description: Optional[str] = Field(default=None, description="A description for the web page.")
    ...
    family_friendly: bool = Field(default=None, description="Whether the web page is family friendly.")
